            ...
            <div class="row">
                <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
                    <div class="card card-signin my-5">
                        <div class="card-body">
                            <h5 class="card-title text-center">Formulário de doação</h5>
                            <form class="form-signin" action="controller/doador.php?op=cadastro" method="POST">
                                ...
                                <div class="form-label-group">
                                    <input name="data" type="text" id="data" class="form-control" placeholder="Data da doação" required>
                                ...
                                <hr>
                                <div>
                                    Quais itens você gostaria de doar?
                                </div>

                                <div class="form-label-group mt-1">
                                    <textarea name="descricaoitens" rows="3" type="text" id="descricaoitens" class="form-control" placeholder="Descrição dos itens" required></textarea>
